...
An initial prototype performed very well. Here is a benchmark where we materialize a record Point(int x, int y) (benchmarks 'pointMapper') and an array of three int components (benchmarks 'arrayMapper'):
