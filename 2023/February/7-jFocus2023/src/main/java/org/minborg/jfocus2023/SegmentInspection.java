...
import static org.minborg.jfocus2023.SegmentInspectionUtil.STANDARD_VALUE_LAYOUT_RENDERER;
 ...
 * @since 20
 */
public final class SegmentInspection {

    // Suppresses default constructor, ensuring non-instantiability.
    private SegmentInspection() {
    }
     ...
     * ).withName("Point");
     *
     * SegmentInspection.inspect(segment, layout, ValueLayoutRenderer.standard())
    ...
    public static Stream<String> inspect(MemorySegment segment,
        ...
        return SegmentInspectionUtil.inspect(segment, layout, renderer);
    }

    /**
     * Returns a human-readable view of the provided {@linkplain MemorySegment memory} viewed
     * through the provided {@linkplain MemoryLayout layout} using the standard renderer.
     * <p>
     * The exact format of the returned view is unspecified and should not
     * be acted upon programmatically.
     * <p>
     ...
     * ).withName("Point");
     *
     * SegmentInspection.inspect(segment, layout)
     *     .forEach(System.out::println);
     *
     *}
     * might be rendered to something like this:
    ...
    public static Stream<String> inspect(MemorySegment segment,
        ...
        requireNonNull(segment);
        requireNonNull(layout);
        return SegmentInspectionUtil.inspect(segment, layout, standardRenderer());
    }
